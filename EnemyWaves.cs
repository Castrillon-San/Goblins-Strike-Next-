...
public class EnemyWaves : MonoBehaviour
{
    ...
    private void Awake()
    {
        /*enemie1 = GameObject.Find("Goblin");
        enemie2 = GameObject.Find("Goblin");
        enemie3 = GameObject.Find("Goblin");
        enemie4 = GameObject.Find("Goblin");*/
    }
    ...
    IEnumerator WaveGenerator()
    {
        ...
        {
            case 1:
                numEnemiesVector[0] = 5;
                numEnemiesVector[1] = 3;
                numEnemiesVector[2] = 1;
                numEnemiesVector[3] = 0;
